...
const CDC_MIGRATION: Diagram = {
  ...
  nodes: [
    ...
    { id: "src_s3", name: "AWS S3", icon: "aws_s3", subtitle: "Historical Files", zone: "sources", x: 300, y: 1340, details: { notes: "CSV/Parquet batch backfill exports" } },
    { id: "src_oracle", name: "On-Prem Oracle", icon: "oracle", subtitle: "Legacy DB", zone: "sources", x: 100, y: 460, details: { notes: "Oracle 12c+ with LogMiner for CDC" } },
...
const BLUEPRINT: Diagram = {
  ...
  nodes: [
    ...
    { id: "conn_vpn", name: "VPN / Private Link", icon: null, subtitle: "Secure network tunnels", zone: "connectivity", x: 650, y: 820, details: { notes: "Site-to-site VPN or cloud Private Link for secure connectivity.\nSupports: IPsec, WireGuard, AWS PrivateLink, Azure Private Endpoint, GCP Private Service Connect." } },
