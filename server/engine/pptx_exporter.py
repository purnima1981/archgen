...
ZONES = [
    ...
    (635, 495, 195, 490, "PIPELINE (L3→L5)", C["pipeline"], True, False),
    (855, 495, 195, 490, "MEDALLION (L6)", C["medallion"], True, False),
    (855, 255, 195, 190, "SERVING (L7)", C["serving"], True, False),
...
NODE_POSITIONS = {
    ...
    "datastream":  (660, 830,  "Datastream",   "CDC Stream",     "pipeline",  "⚡"),
    "gcs":         (660, 680,  "GCS Raw",      "Landing Zone",   "pipeline",  "📦"),
    "gcs_raw":     (660, 680,  "GCS Raw",      "Landing Zone",   "pipeline",  "📦"),
    "bq_staging":  (660, 580,  "BQ Staging",   "Staging",        "pipeline",  "📦"),
    "dataform":    (660, 530,  "Dataform",     "SQL ELT (dbt)",  "pipeline",  "⚙️"),
    "dataflow_proc":(660, 530, "Dataflow",     "Processing",     "pipeline",  "⚙️"),
    "dataproc":    (660, 530,  "Dataproc",     "Spark",          "pipeline",  "⚙️"),
    "bronze":      (880, 830,  "Bronze",       "Raw / dedup",    "medallion", "🥉"),
    "silver":      (880, 680,  "Silver",       "Cleaned",        "medallion", "🥈"),
    "gold":        (880, 530,  "Gold",         "Curated",        "medallion", "🥇"),
    "looker":      (880, 270,  "Looker",       "Governed BI",    "serving",   "📊"),
    ...
    "looker_studio":(1060,270, "Looker Studio","Dashboards",     "serving",   "📊"),
...
if __name__ == "__main__":
    ...
    test_diagram = {
        ...
        "nodes": [
            ...
            {"id": "datastream", "name": "Datastream", "x": 660, "y": 830},
            {"id": "gcs_raw", "name": "GCS Raw", "x": 660, "y": 680},
            {"id": "dataform", "name": "Dataform", "x": 660, "y": 530},
            {"id": "bronze", "name": "Bronze", "x": 880, "y": 830},
            {"id": "silver", "name": "Silver", "x": 880, "y": 680},
            {"id": "gold", "name": "Gold", "x": 880, "y": 530},
            {"id": "looker", "name": "Looker", "x": 880, "y": 270},
